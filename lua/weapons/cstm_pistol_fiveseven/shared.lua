...
if ( CLIENT ) then
	...
	SWEP.WElements = {
		...
		["reflex"] = { type = "Model", model = "models/wystan/attachments/2octorrds.mdl", pos = Vector(5, 0.899, -2.7), angle = Angle(0, 90, 180), size = Vector(1.25, 1.25, 1.25), color = Color(255, 255, 255, 0), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
